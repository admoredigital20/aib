...
export default function CourseDiv() {
    ...
    const filterItem = (categItem) => {
        const selectedCourse = courses.results.data.filter((curElem) => {
            ...
            <div className="container">
                <Row>
                    ...
                    <Col md={9} className="all-course-cat">
                        <div className="course-cat  course-cat-active" onClick={(e) => { filterItem('Data Science & ML'); activeBtn(e) }} ><h5>Data Science & ML</h5></div>
                            <div className="course-cat" onClick={(e) => { filterItem('Deep Learning'); activeBtn(e) }} ><h5>Deep Learning</h5></div>
                            <div className="course-cat" onClick={(e) => { filterItem('Artificial Intelligence'); activeBtn(e) }}><h5>Artificial Intelligence</h5></div>
                    </Col>
                </Row>
                <Row>
